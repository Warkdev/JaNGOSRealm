...
public enum ItemSubClassEnum {
    ...
    private ItemSubClassEnum(byte value) {
        this.value = value;
    }
     ...
     * match.
     */
    public static ItemSubClassEnum convert(byte value) {
        for (ItemSubClassEnum v : ItemSubClassEnum.values()) {
            if (v.getValue() == value) {
                return v;
            }
        }
    ...
    public static boolean exists(byte value) {
        for (ItemSubClassEnum g : ItemSubClassEnum.values()) {
            if (g.getValue() == value) {
                return true;
            }
        }
