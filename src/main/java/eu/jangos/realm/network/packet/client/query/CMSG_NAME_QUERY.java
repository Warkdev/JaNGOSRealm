 ...
 * @version v0.1 BETA.
 */
public class CMSG_NAME_QUERY extends AbstractRealmClientPacket {
     ...
     * @param opcode
     */
    public CMSG_NAME_QUERY(Opcodes opcode, short size) {
        super(opcode);
        this.size = size;
    }
    ...
    public String toString() {
        String toString = "[CMSG_NAME_QUERY [id: "+this.id                
                +"]]";
