 ...
 * @version v0.1 BETA.
 */
public class CMSG_GUILD_QUERY extends AbstractRealmClientPacket {
     ...
     * @param opcode
     */
    public CMSG_GUILD_QUERY(Opcodes opcode, short size) {
        super(opcode);
        this.size = size;
    }
    ...
    public String toString() {
        String toString = "[CMSG_GUILD_QUERY [id: "+this.id                
                +"]]";
