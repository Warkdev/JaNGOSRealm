 ...
 * @version v0.1 BETA.
 */
public class SMSG_CHAR_DELETE extends AbstractRealmServerPacket {
        
    /**
     * The character result sent by the server.
     */
    private CharDeleteEnum result;
            
    public SMSG_CHAR_DELETE(Opcodes code) {
        super(code, 3);
    }    

    public CharDeleteEnum getResult() {
        return result;
    }

    public void setResult(CharDeleteEnum result) {
        this.result = result;
    }        
    
    public String toString(){        
        String toString = "[SMSG_CHAR_DELETE [ Result: "+this.result+" ]]";
        return toString;
    }
